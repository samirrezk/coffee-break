...
Autodesk Platfrom Services (APS) Data Management + AutoCAD Design Automation web app for browsing DWG files in Forma Data Management (formerly known as ACC Docs), running automation jobs, and uploading successful outputs back as new file versions.
